...
namespace Altseed2.ToolAuxiliary
{
    ...
    public sealed class ColorEdit3 : ToolComponent
    {
        ...
        /// <summary>
        /// 指定された色と文字列を持つ<see cref="ColorEdit3"/>の新しいインスタンスを生成する
        /// </summary>
        public ColorEdit3() : this(string.Empty, new Color(255, 255, 255, 255)) { }
        /// <summary>
        /// 指定された色と文字列を持つ<see cref="ColorEdit3"/>の新しいインスタンスを生成する
        /// </summary>
        /// <param name="label">表示される文字列</param>
        /// <param name="value">色</param>
        public ColorEdit3(string label, Color value)
        {
            Color = value;
            Label = label;
        }
        ...
        {
            var color = Color;
            if (!Engine.Tool.ColorEdit3(Label ?? string.Empty, ref color, Flags)) return;
