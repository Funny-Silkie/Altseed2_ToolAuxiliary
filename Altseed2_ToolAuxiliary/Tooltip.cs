...
{
    /// <summary>
    /// マウスカーソルの傍に表示されるウィンドウのクラス
    /// </summary>
    [Serializable]
    public class Tooltip : ToolComponent, IComponentRegisterable<ToolComponent>
    {
        /// <summary>
        ...
        /// <summary>
        /// <see cref="Tooltip"/>の新しいインスタンスを生成する
        /// </summary>
        public Tooltip() { }
        /// <summary>
        /// コンポーネントを追加する
