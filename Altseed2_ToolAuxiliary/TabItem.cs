...
{
    /// <summary>
    /// <see cref="TabBar"/>に登録されるツールコンポーネントのクラス
    /// </summary>
    [Serializable]
    public class TabItem : ToolComponent, IComponentRegisterable<ToolComponent>
    {
        /// <summary>
        ...
        /// <summary>
        /// 指定した文字列を持つ<see cref="TabItem"/>の新しいインスタンスを生成する
        /// </summary>
