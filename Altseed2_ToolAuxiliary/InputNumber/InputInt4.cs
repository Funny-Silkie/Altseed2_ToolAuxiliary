...
namespace Altseed2.ToolAuxiliary
{
    ...
    /// </summary>
    [Serializable]
    public class InputInt4 : ToolComponent
    {
        /// <summary>
        /// 最大値1を取得または設定する
        /// </summary>
        ...
        /// <summary>
        /// 既定の値を用いて<see cref="InputInt4"/>の新しいインスタンスを生成する
        /// </summary>
        public InputInt4() : this(string.Empty, default, default, default, default) { }
        /// <summary>
        /// 指定した値を用いて<see cref="InputInt4"/>の新しいインスタンスを生成する
        /// </summary>
        ...
        public InputInt4(string label, int value1, int value2, int value3, int value4)
        {
            Label = label;
            Value1 = value1;
            Value2 = value2;
        ...
        internal override void Update()
        {
            ...
            if (Engine.Tool.InputInt4(Label ?? string.Empty, array)) return;
