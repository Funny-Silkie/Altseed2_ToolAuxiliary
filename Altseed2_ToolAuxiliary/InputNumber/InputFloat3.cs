...
namespace Altseed2.ToolAuxiliary
{
    ...
    /// </summary>
    [Serializable]
    public class InputFloat3 : ToolComponent
    {
        /// <summary>
        /// 最大値1を取得または設定する
        /// </summary>
        ...
        /// <summary>
        /// 既定の値を用いて<see cref="InputFloat3"/>の新しいインスタンスを生成する
        /// </summary>
        public InputFloat3() : this(string.Empty, default, default, default) { }
        /// <summary>
        /// 指定した値を用いて<see cref="InputFloat3"/>の新しいインスタンスを生成する
        /// </summary>
        /// <param name="label">表示する文字列</param>
        /// <param name="value1">初期値1</param>
        /// <param name="value2">初期値2</param>
        /// <param name="value3">初期値3</param>
        public InputFloat3(string label, float value1, float value2, float value3)
        {
            Label = label;
            Value1 = value1;
            Value2 = value2;
        ...
        internal override void Update()
        {
            ...
            if (Engine.Tool.InputFloat3(Label ?? string.Empty, array)) return;
